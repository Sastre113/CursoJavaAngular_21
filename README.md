...
Crearemos una superclase llamada Electrodomestico con las siguientes características:
	• Sus atributos son precio base, color, consumo energético (letras entre A yF) y peso.
		Indica que se podrán heredar.
	• Por defecto, el color sera blanco, el consumo energético sera F, el precioBase es 
...
Los métodos que implementara serán:
	...
	• comprobarConsumoEnergetico(char letra) : comprueba que la letra es correcta, sino 
		es correcta usara la letra por defecto. Se invocara al crear el objeto 
		y no sera visible. 		
...
siguiente formato: “El libro con ISBN creado por el autor tiene páginas”
...
sexo. De los estudiantes, queremos saber también su calificación actual (entre 0 y 10) y del
...
su sitio)
El profesor tiene un 20 de no encontrarse disponible ( baja, etc.). 
